function dataOut=createPopulation(populationSize,dataLength,data)
...
perfect(2,:)=sin(2*pi*8*t);
perfect(3,:)=cos(2*pi*14*t);
% perfect(5,:)=cos(2*pi*28*t);
perfect(4,:)=cos(2*pi*8*t);

perfect(5,:)=sin(2*pi*14*t);
perfect(6,:)=sin(2*pi*8*t);
perfect(7,:)=cos(4*pi*14*t);
perfect(8,:)=cos(4*pi*8*t);
